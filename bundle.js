...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _RouteNotFound = __webpack_require__(276);
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            null,
	            _react2.default.createElement(_reactRouterDom.Route, { exact: true, path: "/", component: _Posts2.default }),
	            _react2.default.createElement(_reactRouterDom.Route, { path: "/post/:id", component: _Post2.default }),
	            _react2.default.createElement(_reactRouterDom.Route, { path: "*", component: _RouteNotFound2.default })
	          )
	        )
	      );
	    }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _MemoryRouter = __webpack_require__(225);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _createBrowserHistory2 = __webpack_require__(212);

	var _createBrowserHistory3 = _interopRequireDefault(_createBrowserHistory2);

	var _createHashHistory2 = __webpack_require__(222);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _StaticRouter = __webpack_require__(239);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _withRouter = __webpack_require__(244);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Posts = function (_Component) {
	  ...
	  _createClass(Posts, [{
	    ...
	    key: "renderLengthPosts",
	    value: function renderLengthPosts(posts) {
	      if (posts) {
	        return _react2.default.createElement(
	          "h1",
	          null,
	    ...
	    value: function render() {
	      ...
	      var _props = this.props,
	          posts = _props.posts,
	          delete_fetch_posts = _props.delete_fetch_posts;
	...
	function mapDispatchToProps(dispatch) {
	  return (0, _redux.bindActionCreators)({ fetch_posts: _index.fetch_posts, delete_fetch_posts: _index.delete_fetch_posts }, dispatch);
	}

	exports.default = (0, _reactRouterDom.withRouter)((0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(Posts));
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.delete_fetch_posts = delete_fetch_posts;
	exports.active_post = active_post;

	var _actionsType = __webpack_require__(248);
	...
	function fetch_posts() {
	  return function (dispatch) {
	    _axios2.default.get("https://jsonplaceholder.typicode.com/posts?_limit=10").then(function (res) {
	      dispatch({ type: _actionsType.FETCH_POSTS, payload: res.data });
	    });
	  };
	}

	function delete_fetch_posts(id) {
	  return function (dispatch) {
	    (0, _axios2.default)("https://jsonplaceholder.typicode.com/posts/" + id, {
	      method: "DELETE"
	    }).then(function (res) {
	      dispatch({ type: _actionsType.DELETE_FETCH_POSTS, payload: {
	          id: id,
	          loading: true
	        } });
	    });
	...
	function active_post(id) {
	  return function (dispatch) {
	    _axios2.default.get("https://jsonplaceholder.typicode.com/posts/" + id).then(function (res) {
	      dispatch({ type: _actionsType.ACTIVE_POST, payload: res.data });
	    });
	  };
	}
...
/***/ (function(module, exports) {
	...
	var ERROR_FETCH_POSTS = exports.ERROR_FETCH_POSTS = "ERROR_FETCH_POSTS";
	var DELETE_FETCH_POSTS = exports.DELETE_FETCH_POSTS = "DELETE_FETCH_POSTS";
	var ACTIVE_POST = exports.ACTIVE_POST = "ACTIVE_POST";
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function mapDispatchToProps(dispatch) {
	  return (0, _redux.bindActionCreators)({ active_post: _index.active_post }, dispatch);
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var RouteNotFound = function (_Component) {
	  ...
	  function RouteNotFound(props) {
	    ...
	    var _this = _possibleConstructorReturn(this, (RouteNotFound.__proto__ || Object.getPrototypeOf(RouteNotFound)).call(this, props));
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _PostsReducer = __webpack_require__(278);

	var _PostsReducer2 = _interopRequireDefault(_PostsReducer);

	var _activePostReducer = __webpack_require__(279);

	var _activePostReducer2 = _interopRequireDefault(_activePostReducer);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var rootReducer = (0, _redux.combineReducers)({
	  posts: _PostsReducer2.default,
	  activePost: _activePostReducer2.default
	});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = function () {
	  ...
	  switch (actions.type) {
	    case _actionsType.FETCH_POSTS:
	      return actions.payload;
	    case _actionsType.ERROR_FETCH_POSTS:
	      return actions.error;
	    case _actionsType.DELETE_FETCH_POSTS:
